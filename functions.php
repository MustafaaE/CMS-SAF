...
if ( ! function_exists( 'custom_theme_setup' ) ) {
	...
	function custom_theme_setup() {
		...
		register_nav_menus(
			[
				'primary' => esc_html__( 'Main navigation', 'customtheme' ),
				'footer'  => esc_html__( 'Footer navigation', 'customtheme' ),
			]
		);
		...
		add_image_size( 'wcm-gallery', '400', '250', true );
	}
}
...
add_action( 'init', 'my_custom_tax',15 );
